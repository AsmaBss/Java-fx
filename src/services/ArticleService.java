...
public class ArticleService {
    ...
    public void ajouterArticle(Article a){
        ...
        try {
            String sql = "insert into article(titre,description,date,img,employer_id)"
                    +"values(?,?,?,?,?)";
    ...
    public ObservableList<Article> afficherArticleUser(User u) {
        ObservableList<Article> art = FXCollections.observableArrayList();
        
        
        String requete = "SELECT * FROM article where employer_id="+u.getId();
        try {
