 ...
 * @author hp
 */
public class update_candidatController implements Initializable {
...
User u = new User();
    @FXML
    private void update_candidat(MouseEvent event) throws IOException {
    ...
    public void updateField() throws IOException {
        ...
        this.imageToPost.setImage(image);
               ...
               AnchorPane pane = FXMLLoader.load(getClass().getResource("/gui/Affichage.fxml"));
